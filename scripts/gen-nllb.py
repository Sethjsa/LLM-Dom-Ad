...
def generate_translations(lang_pair, domain):
    ...
    try:
        ...
        with open(f"/home/saycock/LLM-Dom-Ad/tests/{domain}-{direction}.src", "w") as f:
            f.write("\n".join(sents))
        ...
        with open(f"/home/saycock/LLM-Dom-Ad/tests/{domain}-{direction}.eval", "w") as f:
            f.write("\n".join(output_result))
        ...
        with open(f"/home/saycock/LLM-Dom-Ad/tests/{domain}-{direction}.ref", "w") as f:
            f.write("\n".join(refs))
...
def main():
    ...
    generate_translations(args.lang_pair, args.domain)
